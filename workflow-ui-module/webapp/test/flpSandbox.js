		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#orderappworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"orderappworkflowuimodule-display": {
								"semanticObject": "orderappworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=orderapp.workflowuimodule",
									"url": sap.ui.require.toUrl("orderapp/workflowuimodule")
								}
							}
						}
					}
